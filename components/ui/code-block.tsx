  ...
  return (
    ...
    >
      ...
      {codeContent.length > 1 && (
        <div className="flex items-center relative pe-2.5">
          <div
            role="tablist"
            className={cn(
              "flex-1 min-w-0 text-xs leading-6 rounded-ss-xl gap-1 flex",
                ...
                >
                  ...
                  {activeTab === index && (
                    <motion.div
                      ...
                      className="absolute bottom-0 start-0 end-0 h-0.5 bg-zinc-950 dark:bg-zinc-50 rounded-full"
                      transition={{
                        type: "spring",
                        stiffness: 500,
                        damping: 35,
